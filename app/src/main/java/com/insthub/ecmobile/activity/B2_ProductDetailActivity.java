...
import com.external.texthtml.HtmlTextView;
...
public class B2_ProductDetailActivity extends BaseActivity implements BusinessResponse, IXListViewListener {
    ...
    TextView mProductDetailCount;
    ImageView mProductDetailAdd;
...
//    private TextView countDownTextView;
    private HtmlTextView textDescrip;
...
//    private ImageView share;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProductDetailCount = (TextView)findViewById(R.id.product_detail_count);
        mProductDetailCount.setText("1");
        ...
        dataModel.fetchGoodDetail(Integer.parseInt(dataModel.goodId));//商品详情
         dataModel.goodsDesc(Integer.parseInt(dataModel.goodId));//商品描述
//        goodDetailPhotoList = (HorizontalVariableListView) headView.findViewById(R.id.good_detail_photo_list);
        googPhotoVp = (ViewPager)headView.findViewById(R.id.good_detail_photo_vp);
//        photoListAdapter = new B3_ProductPhotoAdapter(this, dataModel.goodDetail.pictures);
        bannerListView = new ArrayList<View>();

        photosAdapter = new Bee_PageAdapter(bannerListView);
...
//        countDownTextView = (TextView) headView.findViewById(R.id.count_down);
        ...
        goodCategoryTextView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
...
//        goodBasicParameterLayout.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
...
//            }
//        });
        textDescrip = (HtmlTextView)headView.findViewById(R.id.good_basic_parameter_tv);
...
//        });
        ...
        addToCartTextView = (Button) findViewById(R.id.add_to_cart);
        addToCartTextView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (uid.equals("")) {
                    ...
                    isBuyNow = false;
                    cartCreate();
//                    Intent it = new Intent(B2_ProductDetailActivity.this,EcmobileMainActivity.class);
...
//                    B2_ProductDetailActivity.this.finish();
        ...
        buyNowTextView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                String uid = shared.getString("uid", "");
                if (uid.equals("")) {
        ...
        goodDetailShoppingCart.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                String uid = shared.getString("uid", "");
                if (uid.equals("")) {
...
//            mProductDetailCount.setText(ShoppingCartModel.getInstance().goods_num + "");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if ((keyCode == KeyEvent.KEYCODE_BACK)) {
            finish();
            overridePendingTransition(R.anim.anim_hold, R.anim.my_scale_finish);
            return false;
        }
        return true;
    }
...
//            goodDetailPhotoList.setAdapter(photoListAdapter);
            ...
            if (responseStatus.succeed == 1) {
                Intent it1 = new Intent(B2_ProductDetailActivity.this,EcmobileMainActivity.class);
                    it1.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    it1.putExtra("toShopCart",true);
                    startActivity(it1);
                    overridePendingTransition(R.anim.anim_hold,R.anim.push_buttom_out);
                    B2_ProductDetailActivity.this.finish();
            ...
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else if(url.endsWith(ApiInterface.GOODS_DESC)){
            //商品描述
            STATUS s = new STATUS();
            s.fromJson(jo.optJSONObject("status"));
            if (s.succeed ==1) {
                Log.e("hshs", "...." + dataModel.goodsWeb);
                textDescrip.setHtmlFromString(dataModel.goodsWeb,false);
    ...
    public void addPhotoDetail(){
        ...
        for (int i=0;i<dataModel.goodDetail.pictures.size();i++){
            ...
            if(imageType.equals("high")) {
                ...
                imageLoader.displayImage(photo.small,viewOne, EcmobileApp.options);
            } else {
            ...
            try
            {
                viewOne.setTag(photo.toJson().toString());
            }
        ...
        photosAdapter.mListViews = bannerListView;
        googPhotoVp.setAdapter(photosAdapter);
    ...
    public void addProduct(){
        int count = Integer.parseInt(mProductDetailCount.getText().toString().trim());
        if (count>0){
            count++;
            mProductDetailCount.setText(Integer.toString(count));
            GoodDetailDraft.getInstance().goodQuantity= count;
        }

    }
    @OnClick(R.id.product_detail_minus)
