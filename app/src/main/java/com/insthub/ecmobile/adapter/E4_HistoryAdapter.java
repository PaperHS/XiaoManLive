...
import com.insthub.ecmobile.activity.H1_OrderDetailActivity;
		...
		if(convertView == null) {
            ...
            convertView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent it = new Intent(context, H1_OrderDetailActivity.class);
            ...
            holder.count = (TextView) convertView.findViewById(R.id.trade_item_count);
            holder.stauts = (TextView)convertView.findViewById(R.id.trade_item_status);
...
//			holder.ok = (Button) convertView.findViewById(R.id.trade_item_ok);
			...
			for(int i=0;i<goods_list.size();i++) {
                goodCount+= Integer.parseInt(goods_list.get(i).goods_number);
...
//		holder.score.setText("-"+order.formated_integral_money);
        ...
        holder.count.setText(goodCount+"个");
        holder.stauts.setText(order.order_status);
