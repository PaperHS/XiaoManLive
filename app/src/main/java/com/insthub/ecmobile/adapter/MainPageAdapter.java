...
public class MainPageAdapter extends FragmentPagerAdapter {
	private List<ShopFragment> mFragmentList = new ArrayList<>();

	public MainPageAdapter(FragmentManager manager, List<ShopFragment> fragments) {
		super(manager);
	...
	public void updateList(List<ShopFragment> fragmentList) {
		mFragmentList.clear();
