...
public class ShoppingCartModel extends BaseModel {
    ...
    // 订单生成
    public void flowDone(String pay_id, String shipping_id, String bonus, String score, String inv_type, String inv_payee, String inv_content,String shipTime) {
